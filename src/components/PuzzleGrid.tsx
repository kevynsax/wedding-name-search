...
export const PuzzleGrid: React.FC<PuzzleGridProps> = ({ showCircles = true }) => {
    ...
    return (
        <div className="puzzle-container">
            ...
            <div className="grid-container">
                ...
                {/* SVG overlay for word highlighting - hidden when printing */}
                {showCircles && (
                    <svg
                        className="word-highlights print-hidden"
